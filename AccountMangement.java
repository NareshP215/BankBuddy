...
public class AccountMangement {
    ...
    void updateSavingAccount(Scanner sc, Connection con) throws Exception {
        ...
        if (checkAccountNumber(accountNumber, pin, con)) {
            ...
            bw.write("----------------------------------------------------");
            bw.newLine();
            bw.write(" Update In Account ");
            bw.newLine();
            bw.write("Full Name: " + fName);
            bw.newLine();
            bw.write("Date Of Brith: " + DOB);
            bw.newLine();
            bw.write("Mobile Number: " + mobileNumber);
            bw.newLine();
            bw.write("Address: " + address);
            bw.newLine();
            bw.write(": " + annualTurnover);
            bw.newLine();
            bw.write("----------------------------------------------------");
            bw.newLine();
    ...
    void displaySavingAccountDetails(Scanner sc, Connection con) throws Exception {
        ...
        if (checkAccountNumber(accountNumber, pin, con)) {
            ...
            while (rs.next()) {
                ...
                System.out.println("Date Fo Birth: " + rs.getString(5));
    ...
    void displatAllAccount(Connection con) throws Exception {

        System.out.println();
        System.out.println("----------------------");
        System.out.println("| All Saving Accounts |");
        System.out.println("-----------------------");

        String sql1 = "select * from savingaccount";
        PreparedStatement pst1 = con.prepareStatement(sql1);
        ...
        System.out.println(
                "+-------+----------------+---------+----------------------------------+--------------------+------------------+------------------------------+--------------------------------+---------------------+---------------------+-------------------");
        System.out.println(
                "|  Id   | Account Number | Pin     | Full Name                        | Date Of Brith      | Mobile Number    | Email                        | Address                        | Addhar Number       | Pan Number          | Balance          |");
        System.out.println(
                "+-------+----------------+---------+----------------------------------+--------------------+------------------+------------------------------+--------------------------------+---------------------+---------------------+-------------------");
        ...
        while (rs.next()) {
            ...
            String addharNo = rs.getString(9);
            String panNo = rs.getString(10);
            Double balance = rs.getDouble(11);

            System.out.printf(
                    "| %-5d | %-14d | %-7d | %-32s | %-18s | %-16s | %-28s | %-30s | %-19s | %-19s | %-16s |\n",
                    id, accNo, pin, fullName, DOB, mobileNo, email, address, addharNo, panNo, balance);
        ...
        System.out.println();
        System.out.println("------------------------");
        System.out.println("| All Currnet Accounts |");
        System.out.println("------------------------");
        ...
        System.out.println(
                "+-------+--------------------+--------------------+--------------------+---------------------+--------------------------+-----------------------+---------------------+");
        System.out.println(
                "|  Id   | Business Name      | Business Type      | GST Number         | Business Address    | Annual Turn Over         | Owner Name            | Addhar Number       |");
        System.out.println(
                "+-------+--------------------+--------------------+--------------------+---------------------+--------------------------+-----------------------+---------------------+");
        ...
        while (rs2.next()) {
            ...
            String gst = rs2.getString(4);
            String add = rs2.getString(5);
            double turnover = rs2.getDouble(6);
            String ownername = rs2.getString(7);
            String addharno = rs2.getString(8);

            System.out.printf(
                "| %-5d | %-18s | %-18s | %-18s | %-19s | %-24.2f | %-21s | %-19s |\n",
                ID, name, type, gst, add, turnover, ownername, addharno);
            System.out.println(
                    "+-------+--------------------+--------------------+--------------------+---------------------+--------------------------+-----------------------+---------------------+");
